...
vim.keymap.set("n", "<leader>bl", vim.cmd.BufferLineCloseLeft)
vim.keymap.set("n", "<leader>bD", vim.cmd.BufferLineCloseOthers)
vim.keymap.set("n", "<leader>br", vim.cmd.BufferLineCloseRight)
